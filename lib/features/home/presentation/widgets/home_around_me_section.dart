...
class HomeAroundMeSection extends StatelessWidget {
          ...
          children: [
            Row(
              children: [
                ...
                const Icon(LucideIcons.map_pin, color: AppColors.greenMedium, size: 14),
                const SizedBox(width: 4),
                Text(
                  DistanceHelper.maxDistanceFormatted,
                  style: const TextStyle(color: AppColors.greenMedium, fontSize: AppTypo.textXs, fontWeight: FontWeight.w600),
                ),
              ],
            ),
            TextButton(
              ...
              child: const Row(
                children: [
                  Text("Voir sur la carte", style: TextStyle(color: AppColors.greyMedium, fontSize: AppTypo.textXs)),
                  SizedBox(width: 2),
  ...
  Widget _buildEmptyState() => const Center(
        child: Text("Aucune plante trouvée à proximité", style: TextStyle(color: AppColors.greyMedium, fontSize: AppTypo.textS)),
      );

  Widget _buildNoLocationState() => const Center(
        child: Text("Activez la géolocalisation pour voir les plantes autour de vous", textAlign: TextAlign.center, style: TextStyle(color: AppColors.greyMedium, fontSize: AppTypo.textS)),
      );
}
