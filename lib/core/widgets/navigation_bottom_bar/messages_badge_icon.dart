      ...
      builder: (context, messageState) {
        return BlocBuilder<UnreadExchangesCubit, UnreadExchangesState>(
          builder: (context, exchangeState) {
            return BlocBuilder<UnreadDonationsCubit, UnreadDonationsState>(
              builder: (context, donationState) {
                int unreadMessages = 0;
                int unreadExchanges = 0;
                int unreadDonations = 0;
                ...
                if (donationState is UnreadDonationsLoaded) {
                  unreadDonations = donationState.count;
                }

                final totalUnread =
                    unreadMessages + unreadExchanges + unreadDonations;
